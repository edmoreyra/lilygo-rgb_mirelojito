...
//#include "lucilauti480.h"  //unsern Logo
#include "lucilauti480r.h" //unsern Logo
...
void TRGBSuppport::init() {
	Serial.begin(115200);
	Serial.setTimeout(1);	// workaround to minimize blocking time for output to HWCDCSerial (Serial), if no host is connected.
	...
	esp_lcd_panel_draw_bitmap(panel_handle, 0, 0, 480, 480, lucilauti480r);
